...
echartr(option = list(
  xAxis = list(type = "category", data = data$x),
  yAxis = list(type = "value"),
  series = ec_line(data, y = y, smooth = TRUE)
))
```
## Basic area chart
...
echartr(option = list(
  ...
  yAxis = list(type = "value"),
  series = ec_line(data, y = y, areaStyle = list())
))
```
...
echartr(option = list(
  ...
  yAxis = list(type = "value"),
  series = ec_bar(data, y = y, name = "Direct", barWidth = "60%"),
  axisPointer = list(
    type = "shadow"
  )
))
...
echartr(option = list(
  xAxis = list(
    type = "category", data = data$x
  ),
  yAxis = list(type = "value"),
  series = ec_bar(data, y = y, showBackground = TRUE, backgroundStyle = list(
...
echartr(option = list(
  ...
  xAxis = list(type = "category", data = unique(data$year)),
  yAxis = list(type = "value"),
  series = ec_bar(
    data, 
    label = label_option,
