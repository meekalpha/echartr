...
The R package `echartr` provides an interface to the [Echarts](https://echarts.apache.org/en/index.html) JavaScript library for creating interactive charts. 
...
The [option](https://echarts.apache.org/en/option.html) argument is provided as a list of lists:
...
`echartr` provides helper functions for building Echart [series](https://echarts.apache.org/en/option.html#series) from `data.frame`s
